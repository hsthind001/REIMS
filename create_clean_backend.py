# Read the original file (before we added endpoints)
with open('simple_backend_old.py', 'r', encoding='utf-8') as f:
...
with open('simple_backend_clean.py', 'w', encoding='utf-8') as f:
    f.write('\n'.join(final_lines))

print("Clean file created: simple_backend_clean.py")
